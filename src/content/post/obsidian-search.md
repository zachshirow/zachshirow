...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `file:`        | پیدا کردن متن در نام فایل. همه فایل های داخل خزانه را جستجو می کند.<p/>مثال: `file:.jpg` or `file:202209`.                                                                                                                      |
| `path:`        | پیدا کردن متن در مسیر فایل. همه فایل های داخل خزانه را جستجو می کند..<p/>مثال: `path:"Daily notes/2022-07"`.                                                                                                                     |
